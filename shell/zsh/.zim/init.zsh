zimfw() { source /home/usarral/.dotfiles/shell/zsh/.zim/zimfw.zsh "${@}" }
zmodule() { source /home/usarral/.dotfiles/shell/zsh/.zim/zimfw.zsh "${@}" }
typeset -gr _zim_fpath=(/home/usarral/.dotfiles/shell/zsh/.zim/modules/git-info/functions)
fpath=(${_zim_fpath} ${fpath})
autoload -Uz -- coalesce git-action git-info
source /home/usarral/.dotfiles/shell/zsh/.zim/modules/environment/init.zsh
source /home/usarral/.dotfiles/shell/zsh/.zim/modules/input/init.zsh
